...
function Home() {
  ...
  const handleSearch = () => {
    ...
    navigate(
      `/results?destination=${encodeURIComponent(destination.trim())}`
    );
  };

  const handlePopularDestination = (place) => {
        ...
        <div className="border-2 border-black rounded-3xl p-6">
          ...
          <div className="mt-6">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <button
                onClick={() => handlePopularDestination("Dagoretti")}
              ...
              <button
                onClick={() => handlePopularDestination("Kitengela")}
                className="bg-white border-2 border-black rounded-full px-4 py-2 text-sm font-bold hover:bg-[#10B981] transition"
              >
                Kitengela
              </button>
              ...
              <button
                onClick={() => handlePopularDestination("Kilimani")}
                className="bg-white border-2 border-black rounded-full px-4 py-2 text-sm font-bold hover:bg-[#10B981] transition"
              >
                Kilimani
              </button>
